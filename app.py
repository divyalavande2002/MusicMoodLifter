...
st.markdown(
    "<h5 style='text-align: center; color: black;'><b>Click on the name of recommended song to reach website</b></h5>",
    unsafe_allow_html=True)
...
# Normal text
st.markdown("<h5 style='text-align: center; color: black;'><b>Recommended song's with artist names</b></h5>",
            unsafe_allow_html=True)
try:
